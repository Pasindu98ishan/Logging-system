                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="User Actions">
                            ...
                            <button type="button" class="btn btn-danger fixed-size-button" id="deactivateBtn" onclick="deactivate(${user.id}, this)">${user.status}</button>
                        </div>
                    </td>
                </tr>`;
                    ...
                    <div class="card-body">
                        <form  method="POST" enctype="form-data">
                            ...
                            <div class="row justify-content-end">
                                <div class="col-auto">
                                    <button type="button" class="btn btn-primary" onclick="closeModal(${user.id})">Update</button>
                                </div>
                                <div class="col-auto">
